...
void InputOperatorCamera::SetCamera(GameObject* pCameraGameObject)
{
	m_pCamera = pCameraGameObject;
}
...
void InputOperatorCamera::Dispatch()
{
	...
	//	const int a = 1;
	//	float val = m_pCamera->m_pTransform->localPosition.z;
	...
	//	m_pCamera->m_pTransform->localPosition.z += 3.0f * 0.01f;
	//	val = m_pCamera->m_pTransform->localPosition.z;
	...
	//	m_pCamera->m_pTransform->localPosition.x -= 3.0f * g_pTime->m_deltaTime;
	//}

	////s
	//g_pGameController->GetButton(GCBTN_S, &gameButton);
	//if (gameButton->GetValue().x == 1) {
	//	m_pCamera->m_pTransform->localPosition.z -= 3.0f * g_pTime->m_deltaTime;
	//}

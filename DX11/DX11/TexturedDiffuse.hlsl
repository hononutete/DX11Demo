...
//定数バッファの構造体
//cbuffer cbMatrixWVP : register(b1)
//{
//	float4x4 g_matWVP : packoffset(c0);
//}

////平行射影ライト
//cbuffer cbVecLight : register(b2)
//{
//	float4 g_vecLight : packoffset(c0);
//}
...
////法線変換行列
//cbuffer cbVecNormal : register(b4)
//{
//	float4x4 g_matNormal : packoffset(c0);
//}
